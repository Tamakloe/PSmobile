...
# Tests for failed user signup. 
	...
	describe "POST 'create'" do
		...
		# End tests for failed user signup. 
...
# Tests for successful user signup. 
		...
		describe "success" do
			...
			it "should have a welcome message" do
				post :create, :user => @attr
				flash[:success].should =~ /Welcome to ProblemShared/i
			end
...
# End tests for successful user signup. 
	...
	describe "PUT 'update'" do
		...
		describe "failure" do
			...
			it "should have the right title" do
				put :update, :id => @user, :user => @attr
				response.should have_selector("title", :content => "Edit Member")
			end
		end
